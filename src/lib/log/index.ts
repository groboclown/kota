...
export const LOG_NONE = 'fatal'
export type LOG_NONE = 'fatal'
...
const DEFAULT_LOG_LEVEL = LOG_DEBUG // LOG_INFO
...
const LOG_LEVEL_VALUES: { [key: string]: LogLevel } = {
  [LOG_UNIT_TEST]: { unitTest: true, trace: false, debug: false, verbose: false, info: false, warn: true, error: true, fatal: true },
  [LOG_TRACE]: { unitTest: false, trace: true, debug: true, verbose: true, info: true, warn: true, error: true, fatal: true },
  [LOG_DEBUG]: { unitTest: false, trace: false, debug: true, verbose: true, info: true, warn: true, error: true, fatal: true },
  [LOG_VERBOSE]: { unitTest: false, trace: false, debug: false, verbose: true, info: true, warn: true, error: true, fatal: true },
  [LOG_INFO]: { unitTest: false, trace: false, debug: false, verbose: false, info: true, warn: true, error: true, fatal: true },
  [LOG_NOTICE]: { unitTest: false, trace: false, debug: false, verbose: false, info: false, warn: true, error: true, fatal: true },
  [LOG_WARN]: { unitTest: false, trace: false, debug: false, verbose: false, info: false, warn: true, error: true, fatal: true },
  [LOG_ERROR]: { unitTest: false, trace: false, debug: false, verbose: false, info: false, warn: false, error: true, fatal: true },
  [LOG_FATAL]: { unitTest: false, trace: false, debug: false, verbose: false, info: false, warn: false, error: false, fatal: true },
  [LOG_NONE]: { unitTest: false, trace: false, debug: false, verbose: false, info: false, warn: false, error: false, fatal: false },
}
...
export let LOG_WRITER: LogWriter = (level: LOG_LEVELS, source: string, message: string): void => {
